...
public class EconomyQRDecomposer extends Decomposer {
     ...
     */
    public EconomyQRDecomposer(final Matrix inputMatrix) {
        super(inputMatrix);
        qr = null;
        rDiag = null;
    }
     ...
     * @see #decompose()
     */
    public void getH(final Matrix h) throws NotAvailableException {
        if (!isDecompositionAvailable()) {
            throw new NotAvailableException();
        }
     ...
     * @see #decompose()
     */
    public void getR(final Matrix r) throws NotAvailableException {
        if (!isDecompositionAvailable()) {
            throw new NotAvailableException();
        }
        final int columns = inputMatrix.getColumns();
     ...
     * @see #decompose()
     */
    public void getQ(final Matrix q) throws NotAvailableException, WrongSizeException {
        if (!isDecompositionAvailable()) {
            throw new NotAvailableException();
        }
