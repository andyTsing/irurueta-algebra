...
public class GaussJordanElimination {
    ...
    public static void process(Matrix a, Matrix b) 
        ...
        if(a.getRows() != a.getColumns()) throw new WrongSizeException();
        if(b != null && b.getRows() != a.getRows()) throw new WrongSizeException();
        ...
        for(i = 0; i < n; i++){
            ...
            if(value == 0.0) throw new SingularMatrixException();
            pivinv=1.0/value;
    ...
    public static void process(Matrix a, double[] b) 
            throws SingularMatrixException, WrongSizeException{
        Matrix mb = b != null ? Matrix.newFromArray(b) : (Matrix)null;
        process(a, mb);
        if(mb != null){
